...
from clients.http.gateway.accounts.schema import (
    GetAccountsQuerySchema, OpenDepositAccountRequestSchema, OpenSavingsAccountRequestSchema,
    OpenDebitCardAccountRequestSchema, OpenCreditCardAccountRequestSchema, GetAccountsResponseSchema,
    OpenDepositAccountResponseSchema, OpenSavingsAccountResponseSchema, OpenDebitCardAccountResponseSchema,
...
class AccountsGatewayHTTPClient(HTTPClient):
    ...
    def get_accounts_api(self, query: GetAccountsQuerySchema):
        ...
        return self.get(
            ...
            extensions=HTTPClientExtensions(route=APIRoutes.ACCOUNTS)  # Явно передаём логическое имя маршрута
        )
