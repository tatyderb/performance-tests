...
# Шаг 3. Операция пополнения счета
make_topup_operation_response = operations_gateway_client.make_top_up_operation(card_id=card_id, account_id=account_id)
print('Make top up operation response', make_topup_operation_response)